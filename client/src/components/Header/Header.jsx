...
function Header() {
  ...
  return (
    <header>
      <Container>
        <nav className="fixed top-0 left-0 right-0 z-50 flex gap-2 justify-between items-center px-5 py-3 text-md bg-white/95 backdrop-blur-sm border-b border-slate-200">
          <Link to={"/"}>
            <Logo />
          </Link>
            ...
            {authstatus ? (
              <div className="flex flex-row-reverse gap-2">
                ...
                {/* {userData?.isPremium ? (
                  ...
                  <button
                    className="flex items-center gap-2 px-2 py-3 text-white font-semibold rounded-lg bg-slate-800 transition-all duration-300 relative overflow-hidden"
