...
function PermanentDetailConfirmationDialog({
  onCancelClick,
  onConfirmClick,
  deleting,
  message,
      ...
      <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        >
          ...
          <div className="sm:flex sm:items-start">
            <div className="mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-purple-500 sm:mx-0 sm:h-10 sm:w-10">
              <svg
...
export default PermanentDetailConfirmationDialog;
