...
const ProfilePage = () => {
  // const user = {
  //   _id: '67b0756bb6d741180e208e5a',
  //   username: 'ghost',
  //   email: 'ghostrider8255@gmail.com',
  //   avatar: 'https://abcd.png',
  //   isVerified: true,
  //   isPremium: false,
  //   createdAt: '2025-02-15T11:07:23.114Z',
  //   updatedAt: '2025-02-15T11:23:11.202Z'
  // };
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4">
            <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-md">
              ...
              <div className="space-y-4">
                ...
                >
                  {updating ? "updating..." : "Update And Verify Email"}
                </button>
              </div>
            </div>
          </div>
